...
/**
 * Get the KID value from header without validating entire token
 */
cjwt_code_t cjwt_get_header(const char *text, size_t text_len, uint32_t options, cjwt_header_t **jwt);
#endif
